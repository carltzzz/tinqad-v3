    ...
    if pathname == '/qaofficers_directory':
        ...
        sql = """
            ...
            LEFT JOIN public.deg_unit  
              ON qaofficer_deg_unit_id = deg_unit.deg_unit_id
            WHERE
                NOT qaofficer_del_ind    
        """

        cols = [
            'ID', 'Academic Cluster', 'Main Unit', 'Sub-unit', 'Full Name', 'UP Mail', 'Faculty Position',
        ...
        if df.shape[0] > 0:
            ...
            df = df[['Academic Cluster', 'Main Unit', 'Sub-unit', 'Full Name', 'UP Mail', 'Faculty Position',
