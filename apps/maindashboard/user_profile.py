...
def save_profile_changes(save_btn, cancel_btn, confirm_btn, current_userid, fname, mname, sname, suffixname, id_num, livedname, pronouns, bday, bloodtype, phone_num, position, email, password,
